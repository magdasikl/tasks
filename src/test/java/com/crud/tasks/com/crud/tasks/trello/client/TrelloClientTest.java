...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn("magda34890024");
    }
    @Test
    public void shouldFechTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/magda34890024/boards?key=test&token=test&fields=name,id&lists=all");
    ...
    public void shouldCreateCard() throws URISyntaxException {
        ...
        CreatedTrelloCardDto createdTrelloCard = new CreatedTrelloCardDto("1",null,"Test task", "http://test.com");
